...
class ConfusionMatrix(object):
    ...
    本程使用matplotlib-3.2.1(windows and ubuntu)绘制正常
    需要额外安装prettytable库
    """
    ...
    def plot(self):
        ...
        # Label quantity/probability information in the graph
        thresh = matrix.max() / 2
...
if __name__ == '__main__':
    ...
    image_path = 'F:\Old directory'  # Data set path
    ...
    model_weight_path = "./AlexNet2.pth"
